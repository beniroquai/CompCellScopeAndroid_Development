...
extern "C"{
      JNIEXPORT jint JNICALL Java_com_wallerlab_compcellscope_ComputationalCellScopeMain_computeFPM(JNIEnv*, jint);
      JNIEXPORT jint JNICALL Java_com_wallerlab_processing_tasks_ComputeDPCRefocusTask_computeFPM(JNIEnv*, jint);
}
