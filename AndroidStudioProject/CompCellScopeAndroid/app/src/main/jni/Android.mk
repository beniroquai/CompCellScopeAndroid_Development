...
LOCAL_SRC_FILES := native.cpp fpmMain.cpp jsoncpp.cpp cvComplex.cpp dataset_cellScope.json
LOCAL_LDLIBS +=  -llog -ldl
LOCAL_C_INCLUDE := opencv2/core/core.hpp jsoncpp.h cvCmomplex.h dataset_cellScope.json
